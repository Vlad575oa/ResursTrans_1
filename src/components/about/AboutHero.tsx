...
export function AboutHero({ title, description }: AboutHeroProps) {
    return (
        <section className="relative pt-12 pb-6 md:pt-24 md:pb-12 bg-white overflow-hidden">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 text-center">
                ...
                >
                    ...
                    <p className="text-xl md:text-2xl text-anthracite-core/60 max-w-2xl mx-auto leading-relaxed font-serif italic mb-0">
                        {description}
                    </p>
                </motion.div>
            </div>
