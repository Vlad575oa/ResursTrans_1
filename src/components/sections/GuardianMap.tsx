...
export const GuardianMap = () => {
    ...
    return (
        <section className="py-32 bg-anthracite-core relative overflow-hidden flex flex-col items-center">
            ...
            <div className="relative w-full max-w-5xl aspect-[2/1] bg-white rounded-3xl border border-foreground/10 overflow-hidden shadow-2xl">
                {/* Grid Lines */}
                    ...
                    >
                        ...
                        {activeLocation === loc.id && (
                            <motion.div
                                ...
                                className="absolute bottom-10 left-1/2 -translate-x-1/2 w-56 bg-white/90 backdrop-blur-xl border border-foreground/10 p-4 rounded-xl shadow-2xl z-20"
                            >
