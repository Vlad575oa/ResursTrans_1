...
import { Shield, Package, Globe, CheckCircle2, Route, Award } from "lucide-react";
...
function StatItem({ stat, scrollYProgress }: { stat: StatItemSchema; scrollYProgress: any }) {
    const Icon = ICON_MAP[stat.icon as keyof typeof ICON_MAP] || Award;
