    ...
    return (
        <main className="min-h-screen bg-anthracite-core text-cloud-dancer selection:bg-burnt-terra selection:text-white relative overflow-hidden">
            ...
            <div className="absolute inset-0 z-0">
                <div className="absolute inset-0 bg-[url('/images/solutions/bg_photo.png')] bg-cover bg-center opacity-[0.1] mix-blend-overlay grayscale blur-xl scale-110" />
            ...
            <div className="container mx-auto px-6 py-24 md:py-32 max-w-7xl relative z-10">
                    ...
                    {SOLUTIONS.map((item, index) => (
                        ...
                        >
                            ...
                            <h3 className="text-2xl font-bold mb-4 tracking-tight">
                                {t(`SolutionsPage.sections.${item.key}.title`)}
                            </h3>
                            <p className="text-white/40 font-serif italic leading-relaxed">
                                {t(`SolutionsPage.sections.${item.key}.desc`)}
                            </p>
                        </motion.div>
                    ))}
                </div>
                ...
                <div className="mt-32 relative h-[240px] rounded-3xl overflow-hidden border border-white/10 group">
                    <div className="absolute inset-0 bg-[url('/images/solutions/bg_photo.png')] bg-cover bg-center grayscale opacity-50 transition-transform duration-700 group-hover:scale-105" />
